...
MapTo('wknd/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('wknd/components/teaser')(TeaserV1Component, {isEmpty: TeaserV1IsEmptyFn});
MapTo('wknd/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});
MapTo('wknd/components/separator')(SeparatorV1Component);


MapTo('wknd/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('wknd/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('wknd/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('wknd/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn})
MapTo('wknd/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('wknd/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});

MapTo('wknd/components/carousel')(CarouselV1Component);
MapTo('wknd/components/accordion')(AccordionV1Component);
MapTo('wknd/components/tabs')(TabsV1Component);
